...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("-------------------");
        System.out.println("Игрок Х ходит первый.");
        System.out.println("Введите номер клетки в игрового поля");
        ...
        while (winner == null){
            ...
            try {
                ...
                if (!(numInput > 0 && numInput <= 9)) {
                    System.out.println("Ошибка ввода!!!! Введите корректно номер клетки");
                    continue;
                }
            } catch (InputMismatchException e) {
                System.out.println("Ошибка ввода!!!! Введите заного номер клетки");
                continue;
            }
